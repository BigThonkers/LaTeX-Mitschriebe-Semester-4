...
\begin{align*}
A|a\rangle &= a|a\rangle\in\ham_A \\
B|b\rangle &= b|b\rangle\in\ham_B \\
C|c\rangle &= c|c\rangle\in\ham_C
\end{align*}
\begin{align*}
...
\]
\[
|\psi\rangle = \frac{1}{\sqrt{2}}|-\rangle\circ|0\rangle+\frac{1}{\sqrt{2}}|1\rangle\otimes|1\rangle
\]
\item Scalar product:
\begin{align*}
\ham &= \ham_A\otimes\ham_B \\
|\psi\rangle &= |\phi\rangle\otimes|\chi\rangle \\
|\zeta\rangle &= |\nu\rangle\otimes|\zeta\rangle \\
\langle\phi|\zeta\rangle &= ? \\
\langle\psi|\zeta\rangle &= (\langle\phi|\otimes\langle\chi|)(|\nu\rangle\otimes|\zeta\rangle) \\
&= \langle\phi|\nu\rangle \cdot \langle\chi|\zeta\rangle \\
|\psi\rangle &=\sum_{jk}c_j c_{jk}|a_j\rangle\otimes|b_k\rangle \\
|\zeta\rangle &= \sum_{lm}d_{lm}|a_l\rangle\otimes|b_m\rangle \\
\langle\psi|\zeta\rangle &= \left(\sum_{jk}c_{jk}^*\langle a_j|\otimes\langle b_k|\right)\left(\sum_{lm}d_{lm}|a_l\rangle\otimes|b_m\rangle\right) \\
...
\end{align*}
\begin{align*}
(A\otimes 1_B)|\phi\rangle\otimes|\chi\rangle &= (A|\phi\rangle)\otimes|\chi\rangle \\
(1_A\otimes B)|\phi\rangle\otimes|\chi\rangle &= |\phi\rangle \otimes (B|\chi\rangle)
\end{align*}
\begin{align*}
A|a\rangle &= a|a\rangle \\
B|b\rangle &= b|b\rangle \\
(A\otimes 1_B)|a\rangle \otimes |b\rangle &= a|a\rangle \otimes|b\rangle \\
(1_A \otimes B)|a\rangle \otimes |b\rangle &= b|a\rangle \otimes |b\rangle \\
(A\otimes B)|\phi\rangle \otimes|\chi\rangle &= (A|\phi\rangle)\otimes(B|\chi\rangle) \\
&= (A\otimes 1_B)(1_A\otimes B)|\phi\rangle \otimes|\chi\rangle \\
&= (A\otimes 1_B)[|\phi\rangle \otimes(B|\chi\rangle)]
\end{align*}
General form:
\begin{align*}
...
\end{align*}
General $|\psi\rangle \nshortmid |\phi\rangle \otimes |\chi\rangle$ ''Entangled'' % I don't know what this sign is supposed to be. It looks a bit more like a circle than a slash in the middle of the line.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This is ugly as fuck pls fix %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{align*}
\ham_B &\backslash\ham_A \to &|\phi_1&\rangle, &|\phi_2&\rangle, &\ldots \\
\downarrow & &|\phi_1\rangle \otimes|chi_1\rangle &\ldots \\
|\chi_1\rangle & &.\\
|\chi_2\rangle & &.\\
. & &.\\
.\\
