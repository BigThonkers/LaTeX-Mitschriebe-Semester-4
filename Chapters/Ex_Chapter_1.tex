...
\item Zeeman Effekt $\begin{matrix}\rightarrow \textrm{Anomaler Zeeman Effekt} \\ \rightarrow \textrm{Normaler Zeeman Effekt} \\ \rightarrow \textrm{Paschen-Back Effekt}\end{matrix}$ % OwO
\item Spin Bahn Kopplung
\end{itemize}
